      ...
      for (let i = 0; i < files.length; i++) {
        ...
        try {
          ...
          const songData: SongFileData = {
            ...
            colorRanges: (data.colorRanges || data.colorHighlights || []).map(
              (r: any) => ({
    ...
    <div className="space-y-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                disabled={
                  importMutation.isPending || importSongsMutation.isPending
                }
              >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                {exportMutation.isPending || isExportingAll
                  ? "Exporting..."
                  : "Export"}
              </Button>
            </DropdownMenuTrigger>
      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={handleExportCancel}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
